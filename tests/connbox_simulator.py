...
class CboxSimulator:
    ...
    def __init__(self) -> None:
        ...
        self.app.add_routes([web.get("/cgi-bin/sendmsg.lua", self.__send_msg_endpoint)])
    ...
    def __get_alls_response(self) -> web.Response:
        return web.json_response(
            {
                "INFO": {"RSP": "OK", "CMD": "GET ALLS", "TS": 1728725454},
                "SUCCESS": True,
                "DATA": {
                    "T2": 0,
                    "F2LF": 2,
    ...
    def __build_error_response(self, cmd: str) -> web.Response:
        return web.json_response(
            {"INFO": {"RSP": "ERROR", "CMD": cmd, "TS": 1729331226}, "SUCCESS": False, "DATA": {"NODATA": True}}
        )
